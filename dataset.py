...
class fashionMNIST_train(torch.utils.data.Dataset):
    def __init__(self, dataset_path='./data/', transformations=None, should_download=True, remain=None):
        self.dataset_train = torchvision.datasets.FashionMNIST(root=dataset_path,
                                                        transform=transform,
                                                        train=True,
...
class fashionMNIST_test(torch.utils.data.Dataset):
